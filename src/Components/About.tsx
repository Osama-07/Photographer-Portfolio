  ...
  return (
    <div id="about" className="bg-gray-200 pt-20 max-md:py-10">
      <div className="container">
        ...
        <div className="info mt-10 grid grid-cols-2 max-lg:grid-cols-1 max-xl:place-items-center">
          <img
            className="mx-auto max-xl:w-4/6"
            src="/Personal-ImagePNG.PNG"
            alt="Personal Photo"
          />
          <div className="max-md:bg-white max-md:rounded-lg pb-5 max-md:text-center">
            <h1 className="relative md:w-fit max-xl:mx-auto text-2xl font-bold my-10 before:w-1/2 before:h-1 before:bg-orange-500 before:absolute max-md:before:left-1/2 before:-bottom-5 max-xl:before:-translate-x-1/2">
              الـمـصـور &nbsp; <span className="main-color">|</span> &nbsp;
              عـبـدالله عـبـدالـعـزيـز
            </h1>
            <p className="md:bg-white md:p-5 md:rounded-lg w-9/12 leading-relaxed text-gray-700 max-xl:w-full max-xl:text-center max-xl:px-5">
